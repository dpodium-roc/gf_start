...
<h4>Installation</h4>
	<ol>
		<li>CLICK <b>Dashboard</b></li>
		<li>CLICK <b>Plugins</b></li>
		<li>Search the plugin you wanted to install</li>
		<ol>
			<li>If not found, download the zip file of the plugin from any source</li>
			<li>Go back to gravity forms</li> 
			<li>CLICK <b>Add New</b></li>
			<li>CLICK <b>upload plugin</b></li>
...
<h4>Configuration 1</h4>
    <ol>
	    <li>CLICK <b>Dashboard</b></li>
	    <li>HOVER to <b>form</b> [don\'t click <b>form</b>]</li>
	    <li>CLICK <b>Settings</b> [the one that appear after you hover] [not the setting below form]</li>
	    <li>CLICK <b>Pipwave</b></li>
	    <li>ENTER pipwave api key and api secret</li>
	    <li>links are available on the <b>question mark</b></li>
	    <li>Let\'s go to the nest one</li>
    </ol>
<h4>Configuration 2</h4>
    <ol>
	    <li>CLICK <b>Dashboard</b></li>
	    <li>CLICK <b>Form</b> [this time is click it]</li>
	    <li>HOVER/SELECT any form</li>
	    <li>CLICK <b>Settings</b></li>
		<li>CLICK <b>Pipwave</b></li>
		<li>CLICK <b>Addnew</b></li>
